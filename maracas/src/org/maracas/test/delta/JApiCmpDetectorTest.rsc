...
public test bool removedConstructorSimpleAccess()
	= detection(
		|java+method:///mainclient/ConstructorRemovedMI/constructorRemovedClientClass()|,
...
public test bool removedConstructorSimpleAccessParams()
	= detection(
		|java+method:///mainclient/ConstructorRemovedMI/constructorRemovedClientParams()|,
...
public test bool removedConstructorSimpleAccessNoParams()
	= detection(
		|java+method:///mainclient/ConstructorRemovedMI/constructorRemovedClientNoParams()|,
...
public test bool removedConstructorSuperConsParams()
	= detection(
		|java+constructor:///mainclient/ConstructorRemovedExtParams/ConstructorRemovedExtParams()|,
		|java+constructor:///main/ConstructorRemovedParams/ConstructorRemovedParams(int)|,
		methodInvocation(),
		constructorRemoved(binaryCompatibility=false,sourceCompatibility=false))
    in detects;
...
public test bool removedConstructorNoSuperConsParams()
	= detection(
		|java+method:///mainclient/ConstructorRemovedExtParams/constructorRemovedExtParamsNoSuper()|,
		|java+constructor:///main/ConstructorRemovedParams/ConstructorRemovedParams(int)|,
		methodInvocation(),
		constructorRemoved(binaryCompatibility=false,sourceCompatibility=false))
    in detects;
...
public test bool removedConstructorSuperConsNoParams()
	= detection(
		|java+constructor:///mainclient/ConstructorRemovedExtNoParams/ConstructorRemovedExtNoParams()|,
		|java+constructor:///main/ConstructorRemovedNoParams/ConstructorRemovedNoParams()|,
		methodInvocation(),
		constructorRemoved(binaryCompatibility=false,sourceCompatibility=false))
	in detects;
...
public test bool removedConstructorNoSuperConsNoParams()
	= detection(
		|java+method:///mainclient/ConstructorRemovedExtNoParams/constructorRemovedExtNoParamsNoSuper()|,
		|java+constructor:///main/ConstructorRemovedNoParams/ConstructorRemovedNoParams()|,
		methodInvocation(),
		constructorRemoved(binaryCompatibility=false,sourceCompatibility=false))
    in detects;
