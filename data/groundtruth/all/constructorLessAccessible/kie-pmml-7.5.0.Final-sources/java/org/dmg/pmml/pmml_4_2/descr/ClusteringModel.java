...
@XmlType(name = "", propOrder = {
    "extensionsAndClustersAndClusteringFields"
})
...
public class ClusteringModel implements Serializable
{
    ...
    /**
     * Gets the value of the extensionsAndClustersAndClusteringFields property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the extensionsAndClustersAndClusteringFields property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getExtensionsAndClustersAndClusteringFields().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<Serializable> getExtensionsAndClustersAndClusteringFields() {
        if (extensionsAndClustersAndClusteringFields == null) {
            extensionsAndClustersAndClusteringFields = new ArrayList<Serializable>();
        }
