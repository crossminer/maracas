...
public class NaiveBayesModel implements Serializable
{
    ...
    protected List<Serializable> extensionsAndBayesOutputsAndBayesInputs;
     ...
     * 
     */
    public List<Serializable> getExtensionsAndBayesOutputsAndBayesInputs() {
        if (extensionsAndBayesOutputsAndBayesInputs == null) {
            extensionsAndBayesOutputsAndBayesInputs = new ArrayList<Serializable>();
        }
